    ...
    return {
      ...
      enterpriseOptions: {
        ...
        config:{
          // header: ['企业', '招商状态', '时间'],
          data: [
            ['千山易融股权投资管理合伙企业', '完成资产合同', '2022.08'],
            ['京世大数据管理有限公司', '完成物业合同', '2022.08'],
            ['首达建设有限公司', '完成资产合同', '2022.09'],
            ['九核明哲股权投资合伙企业', '已入驻', '2022.04'],
            ['长富投资管理合伙企业', '完成物业合同', '2022.05'],
            ['九核星资股权投资合伙企业', '完成物业合同', '2022.02'],
            ['亨信投资管理合伙企业', '完成资产合同', '2022.08'],
            ['水木知一投资管理合伙企业', '完成物业合同', '2022.02'],
            ['圣本投资管理合伙企业', '已入驻', '2022.05'],
            ['创赢投资管理合伙企业', '完成物业合同', '2022.02']
          ],
          rowNum: 5,
          headerBGC: 'transparent',
          columnWidth: [185, 100, 70],
          align: ['center'],
          waitTime: 1000
      },
      advertising: [
